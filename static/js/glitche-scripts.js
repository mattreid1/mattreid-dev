...
$(function () {
	...
	$('#age-years').html(function () {
		const birthday = new Date(964137600000);
	...
	$('#e').html(function () {
		const e = atob('aGVsbG9AbWF0dHJlaWQuZGV2');
	...
	$(window).scroll(function () {
		$(".scroll-arrow").css("opacity", 1 - $(window).scrollTop() / 200);
	});

	/* Preloader */
	$(window).load(function () {
		$(".preloader .pre-inner").fadeOut(1, function () {
			/* Preload hide */
			$('.preloader').fadeOut();
